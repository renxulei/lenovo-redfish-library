...
if __name__ == "__main__":
    ...
    msg = "%s lenovo_redfish_client.py -i %s -u %s -p %s get_event_log --type system" % (py_name, ip, user, password)
    print(msg)
    sys.stdout.flush()
    #os.system(msg)
    print("")
    ...
    msg = "%s lenovo_redfish_client.py -i %s -u %s -p %s set_bios_password --password_name Q01000_Administrator_Password --new_password Aa123456 --old_password \"\" " % (py_name, ip, user, password)
    print(msg)
    sys.stdout.flush()
    os.system(msg)
    print("")

    msg = "%s lenovo_redfish_client.py -i %s -u %s -p %s set_bios_password --password_name Q01000_Administrator_Password --new_password \"\" --old_password Aa123456" % (py_name, ip, user, password)
    print(msg)
    sys.stdout.flush()
    os.system(msg)
    print("")
    ...
    msg = "%s lenovo_redfish_client.py -i %s -u %s -p %s get_bmc_users" % (py_name, ip, "abcd", "PASSW0RD12q")
    print(msg)
    sys.stdout.flush()
    os.system(msg)
    print("")

    msg = "%s lenovo_redfish_client.py -i %s -u %s -p %s update_bmc_user_password --username abcd --password PASSW0RD=0" % (py_name, ip, user, password)
    print(msg)
    sys.stdout.flush()
    os.system(msg)
    print("")

    msg = "%s lenovo_redfish_client.py -i %s -u %s -p %s get_bmc_users" % (py_name, ip, "abcd", "PASSW0RD=0")
    print(msg)
    sys.stdout.flush()
    os.system(msg)
    print("")
